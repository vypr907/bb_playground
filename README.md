...
1. Deploy Flux to handle syncing
   ...
   # If you are using a different version of Big Bang, make sure to update the `?ref=2.14.0` to the correct tag or branch.
...
```shell
   ...
   git commit -m "feat(dev): update bigbang to 2.14.0"
   git push
```
