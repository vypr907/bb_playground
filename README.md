...
1. Deploy Flux to handle syncing
   ...
   # If you are using a different version of Big Bang, make sure to update the `?ref=2.12.0` to the correct tag or branch.
   kubectl apply -k https://repo1.dso.mil/platform-one/big-bang/bigbang.git//base/flux?ref=2.12.0
...
- Reference for the Big Bang kustomize base:
  ...
  ```yaml
  bases:
  - https://repo1.dso.mil/platform-one/big-bang/bigbang.git/base/?ref=2.12.0
  ```
...
```shell
   ...
   git commit -m "feat(dev): update bigbang to 2.12.0"
   git push
```
